    ...
    return (
      ...
      >
        <Form>
          ...
          <FormItem label="学号">
            {getFieldDecorator('studentId', { rules: [{ required: true }] })(<Input />)}
          </FormItem>
          <FormItem label="学院">
          ...
          <FormItem label="专业">
            {getFieldDecorator('speciality', { rules: [{ required: true }] })(<Input />)}
          </FormItem>
          <FormItem label="入学年份">
            {getFieldDecorator('entryYear', { rules: [{ required: true }] })(<Input />)}
          </FormItem>
        </Form>
      </Modal>
    );
