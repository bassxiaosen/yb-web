    ...
    return (
      <div>
        <section className={styles.resultData}>
          ...
          <Row>
            <Col className={styles.updown} span={8}><span>出勤</span><span><span className={styles.bigSpan}>{checkInNum}</span>人</span></Col>
            <Col className={styles.updown} span={8}><span>出勤率</span><span><span className={styles.bigSpan}>{50}</span>%</span></Col>
            <Col className={styles.updown} span={8}>
              <span>签到开启时长</span>
              <span>
                <span><span className={styles.bigSpan}>1</span>分</span>
                <span><span className={styles.bigSpan}>0</span>秒</span>
              </span>
            </Col>
          </Row>
        </section>
